...
define("AppUrl", "http://localhost/jojo-place");
define("AppImg", "http://localhost/jojo-place/admin/foods-admins/foods-images");
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="<?php echo AppUrl; ?>" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>Jojo Place</h1>
